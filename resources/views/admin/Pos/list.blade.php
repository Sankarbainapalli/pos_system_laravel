                ...
                <div class="card-body">
                  <!-- <div class="form-group row">
                   ...
                   <div class="form-group row" >
                    ...
                    <div class="col-sm-7">
                      ...
                      <input type="text" onkeyup="discountCal(this.value)" class="form-control" id="cus_mobile"  placeholder="" name="cus_mobile" maxlength="10">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                      ...
                      <select class="form-control" style="width: 100%;" id="paidby"  name="payment_method">
